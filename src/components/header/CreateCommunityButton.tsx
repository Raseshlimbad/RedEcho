  ...
  const handleCreateCommunity = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      try {
        ...
        } else if ("subecho" in result && result.subecho) {
          setOpen(false);
          resetForm();
          router.push(`/community/${result.subecho.slug?.current}`);
        }
      } catch (err) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Create a community/subecho to share ideas and get feedback.
          </DialogDescription>
          ...
          <form onSubmit={handleCreateCommunity} className="space-y-4 mt-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                This will be used in the URL: redecho.com/community/
                {slug || "community-slug"}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                name="description"
                placeholder="What is ths community about?"
                className="w-full focus:ring-2 focus:ring-blue-500"
                value={description}
            ...
            <div className="space-y-2">
              ...
              {imagePreview ? (
                <div className="flex items-center justify-center w-full h-24 border-2 border-dashed border-gray-300 rounded-md bg-gray-50">
                ...
                <div className="flex items-center justify-center w-full">
                  <label
                    ...
                    className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-gray-300 rounded-md cursor-pointer bg-gray-50 hover:bg-gray-100"
                  >
